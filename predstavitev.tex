...
\begin{frame}{Hermitova interpolacija}
	...
	\captionof{figure}{Hermitova interpolacija}
	\end{center}
\end{frame}
...
%	Oblika krivulje je odvisna od vrednosti $U$, $V$.
%\end{frame}

\begin{frame}{Klasifikacija}
	\begin{center}
		\includegraphics[width=0.6\columnwidth]{klas.jpg}
		\captionof{figure}{Klasifikacija kubičih parametričnih krivulj, glede na vrednosti $U$, $V$}
	\end{center}
\end{frame}
